...
#
# Generated by Vivado on Thu May 03 23:49:12 PDT 2018
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../Abacus.srcs/sources_1/bd/design_1/ipshared/4868" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/kevin/Projects/RomanWork/Basys-3-Abacus/proj/Abacus.cache/compile_simlib/vcs"
  fi
